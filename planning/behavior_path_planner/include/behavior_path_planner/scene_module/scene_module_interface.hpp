...
public:
  ...
  {
    is_simulateously_executable_as_approved_module_ = enable;
  }

  bool isSimultaneousExecutableAsApprovedModule() const
  {
    return is_simulateously_executable_as_approved_module_;
  }

  void setIsSimultaneousExecutableAsCandidateModule(const bool enable)
  {
    is_simulateously_executable_as_candidate_module_ = enable;
  }

  bool isSimultaneousExecutableAsCandidateModule() const
  {
    return is_simulateously_executable_as_candidate_module_;
  }
...
protected:
  ...
  bool is_simulateously_executable_as_approved_module_{false};
  bool is_simulateously_executable_as_candidate_module_{false};
